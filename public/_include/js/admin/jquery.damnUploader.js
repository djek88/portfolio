(function(window, $) {
    ...
    // определение совместимости объекта управления загрузки
    ...
    // Утилита объект для совместимости проверка браузера
                ...
                if (this.readyState == 4) {
                    ...
                    if (this.status < 400) {
                        if (!uploaded) {
                            ...
                            if(response.post) {
                                if(response.post == 1) {
                                    item.statusRow.html('<div class="error_message">Ошибка<br>ввода</div>')
                                } else {
                                    item.statusRow.html('<div class="error_message">Ошибка<br>ввода</div>')
                                }
                            }
